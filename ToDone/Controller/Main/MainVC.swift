...
class MainVC: UIViewController, Alertable, NSFetchedResultsControllerDelegate, SKProductsRequestDelegate, SKPaymentTransactionObserver {
    ...
    func checkOnLaunch() {
        ...
        if !Shared.instance.isPremium { checkCanMakePayments() }
    }
    
    @objc func settingsPressed(sender: UIButton!) { performSegue(withIdentifier: "showSettings", sender: nil) }
